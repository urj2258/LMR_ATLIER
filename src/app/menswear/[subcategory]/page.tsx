...
export default async function SubcategoryPage({ params }: PageProps) {
    ...
    // Fetch products for this subcategory under Menswear
    const products = await getProductsBySubcategory('Menswear', subcategoryName);
        ...
        <div className="pt-8">
            <section className="max-w-[1440px] mx-auto text-center px-8 mb-16">
                ...
                <nav className="mb-6 flex justify-center items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-gray-400">
                    ...
                    <span>/</span>
                    <Link className="hover:text-[#bd870a]" href="/menswear">Menswear</Link>
                    <span>/</span>
                ...
                <p className="text-[10px] uppercase tracking-[0.4em] opacity-60">Menswear Collection</p>
            ...
            <section className="pb-24 px-8 md:px-20 max-w-[1440px] mx-auto">
                {products.length === 0 ? (
                    <div className="text-center py-20">
                        ...
                        <Link href="/menswear" className="text-[#bd870a] hover:underline mt-4 inline-block">
                            ← Back to Menswear
                        </Link>
                    </div>
                ) : (
