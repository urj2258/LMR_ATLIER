        ...
        <footer className="bg-black text-white pt-20 pb-12 px-6 md:px-12">
            <div className="max-w-[1440px] mx-auto">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 md:mb-20">
                    <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-left">
                        <Link href="/" className="flex flex-col items-center md:items-start group">
                            <span className="text-4xl md:text-5xl lg:text-6xl font-serif tracking-[0.2em] leading-tight text-white group-hover:text-gold-champagne transition-colors uppercase">
                                LMR
                            </span>
                            <span className="text-[10px] md:text-[12px] lg:text-[14px] font-sans tracking-[0.6em] text-gold-champagne uppercase -mt-1 md:-mt-2 ml-1 font-bold">
                                ATELIER
                            </span>
                        </Link>
                    ...
                    <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <ul className="space-y-3 text-sm font-light opacity-80">
                            <li><Link href="/wedding-edit" className="hover:text-gold-champagne transition-colors">Wedding Edit</Link></li>
                            <li><Link href="/bridal-edit" className="hover:text-gold-champagne transition-colors">Bridal Edit</Link></li>
                    ...
                    <div className="space-y-6 flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 opacity-80">
                            ...
                            <a href={`https://wa.me/923288652263`} className="flex items-center gap-2 text-gold-champagne hover:opacity-80 transition-opacity">
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col items-center">
                    <p className="text-[10px] uppercase tracking-[0.4em] opacity-40 text-center">
